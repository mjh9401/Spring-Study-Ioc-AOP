...
public class ClinetRequestHandler implements Runnable {
    private static final Logger logger = LoggerFactory.getLogger(ClinetRequestHandler.class);
    private final Socket clientSocket;

    public ClinetRequestHandler(Socket clientSocket) {
